        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
          <form @submit.prevent="submitForm" class="p-6 space-y-6">
            ...
            <div>
              ...
              <input v-model="form.nombre" required class="form-input" placeholder="Ej: Desarrollador Frontend Senior">
            </div>

            <!-- Descripción -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Descripción*</label>
              <textarea v-model="form.descripcion" required rows="6" class="form-textarea"
            ...
            <div>
              ...
              <div class="relative rounded-md shadow-sm">
                ...
                <input v-model.number="form.salario" type="number" required class="form-input pl-7" placeholder="0.00">
            ...
            <div>
              ...
              <input v-model="form.horario" required class="form-input"
            ...
            <div>
              ...
              <input v-model="form.fechaExpiracion" type="date" required class="form-input"
            ...
            <div>
              ...
              <input v-model="form.habilidadesRequeridas" required class="form-input"
            ...
            <div>
              ...
              <input v-model="form.ubicacion" required class="form-input" placeholder="Ej: Ciudad de México (Remoto)">
            </div>

            <!-- Tipo de Trabajo -->
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Tipo de trabajo*</label>
              <select v-model="form.tipoTrabajo" required class="form-select">
            ...
            <div class="flex justify-end space-x-4 pt-4">
              <router-link to="/empresarial/vacantes" class="btn-cancel">
                Cancelar
              </router-link>
