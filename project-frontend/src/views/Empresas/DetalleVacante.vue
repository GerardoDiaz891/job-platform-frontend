        ...
        <div v-else class="bg-white rounded-xl shadow-md overflow-hidden">
          <div class="bg-gradient-to-r from-blue-600 to-blue-800 p-6 text-white">
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center">
              ...
              <span class="mt-2 md:mt-0 inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-white bg-opacity-20">
                {{ vacante.tipoTrabajo }}
              </span>
            </div>
          </div>
              ...
              <div class="lg:col-span-2">
                ...
                <div v-if="vacante.habilidadesRequeridas" class="mb-8">
                  ...
                  <div class="flex flex-wrap gap-2">
                    <span 
                      v-for="(habilidad, index) in vacante.habilidadesRequeridas.split(',')" 
                      :key="index"
                ...
                >
                  <div class="flex flex-col md:flex-row md:items-center md:justify-between">
                    ...
                    <div class="flex space-x-3">
                      ...
                      <button 
                        @click="contactarPostulante(cv.idUsuario)"
                        class="btn-contact"
                      >
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  export default defineComponent({
    ...
    methods: {
      ...
      async descargarCV(idVacante: number, idUsuario: number) {
        try {
          this.$notify({
            ...
            text: 'Preparando el archivo para descargar...',
            type: 'info'
          });
          ...
          this.$notify({
            title: 'Error',
            text: 'Ocurrió un problema al descargar el CV',
            type: 'error'
          });
        }
      },
      ...
      contactarPostulante(idUsuario: number) {
        this.$notify({
          title: 'Contactar postulante',
          text: `Redirigiendo para contactar al usuario ${idUsuario}`,
          type: 'info'
        });
