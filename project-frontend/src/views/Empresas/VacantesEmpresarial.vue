            ...
            <div class="p-6">
              <div class="flex justify-between items-start mb-3">
                ...
                <span 
                  :class="[
                    ...
                    vacante.cVs.length > 0 ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
                  ]"
                >
                  {{ vacante.cVs.length }} postulante{{ vacante.cVs.length !== 1 ? 's' : '' }}
                </span>
              </div>
              ...
              <div class="space-y-3 mb-5">
                <div class="flex items-center">
                  <svg class="flex-shrink-0 h-5 w-5 text-blue-500 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
